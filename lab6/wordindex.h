 ...
 * term When a matching word is found, the location of word and phrase in which
 * the word is contained is added to the index argument
 *
 * Arguments:
 *  - i: a pointer to a wordindex class object to contain the results of
 *    the search
 *  - target: a string representing the search term
 * Return value: none
 */
 ...
 *  - num_occurrences: an integer representing the total number of instances of
 *    term in the directory
 *  - files: a vector of index class objects containing the search results of
 *    each file
 *
 * Return value: None
 */
 ...
 *
 * Arguments:
 *  - filenames: a reference to a vector of strings to conatin the filenames,
 *  - dirname: a char* refering to the name of the directory
 */
